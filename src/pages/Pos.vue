        ...
        <div class="grid grid-cols-2 gap-2">
          ...
          <div>
            ...
            <div class="flex gap-1.5">
              ...
              <button @click="setExact" title="Aniq summa" class="flex h-9 w-9 shrink-0 items-center justify-center rounded-md border text-muted-foreground hover:bg-muted hover:text-primary"><Magnet class="h-4 w-4 rotate-180" /></button>
            </div>
          </div>
        </div>
