...
// Qayta ishlatiladigan QR-skanerlash tugmasi. Har qanday kalit input yoniga qo'yiladi.
...
function onDecoded(t: string) { open.value = false; emit('decoded', t.trim()) }
</script>

<template>
  <button type="button" @click="open = true" title="QR-kodni skanerlash"
